...
def Load_Model_Structures(name = "All_Model_Structures"):
    model_structures = []
...
def Is_BidirectionalLSTM_Type(model):
...
def Is_BidirectionalGRU_Type(model):
...
def Save_Models(models_list, name):
...
def Split_Save_Models_Into_Categories():
    #Import massive list of all the models
    all_models = Load_Model_Structures()
    ...
    Save_Models(gru_models, "GRU_Model_Structures")
    Save_Models(lstm_models, "LSTM_Model_Structures")
    Save_Models(dense_models, "Dense_Model_Structures")
    Save_Models(blstm_models, "BidirectionalLSTM_Model_Structures")
    Save_Models(bgru_models, "BidirectionalGRU_Model_Structures")
    Save_Models(conv1d_models, "Conv1D_Model_Structures")
    Save_Models(convlstm_models, "ConvLSTM2D_Model_Structures")
    Save_Models(other_models, "Other_Model_Structures")
    
    return

#Generates the huge list of all model layer setups
...
Split_Save_Models_Into_Categories()

models = Load_Model_Structures("Conv1D_Model_Structures")
models = Load_Model_Structures("All_Model_Structures")
models = Load_Model_Structures("Other_Model_Structures")
...
dn = []
for m in models:
    if ("Dense" in m) and ("Flatten" in m):
        dn.append(m)
