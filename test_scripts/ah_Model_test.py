...
class Model_Info:
	...
	def PullAccuracies(self, nested = True, path = "C:/Users/andyh/Desktop/BidirectionalLSTM_Model_Structures1"):
...
for key, value in acc_dict.items():
	print(key)
	for i in value:
		if i['val_acc'] > max_acc:
			max_acc = i['val_acc']
			print("Model Structure index is:", i['model_index'])
			print(i['model_struct'])
			print("ACC Dict index is:", value.index(i))
#------------------------------------------------------------------------------
